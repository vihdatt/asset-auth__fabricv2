...
chaincodeInvoke(){
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        -c '{"function": "CreateAsset","Args":["ASSET3", "Car", "Vinfast Lux A2.0", "43A.23232", "201800994", "Trần Vĩnh Đạt"]}'
    ...
    peer chaincode invoke -o localhost:7050 \
            ...
            --tlsRootCertFiles $PEER0_ORG1_CA \
            --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA $PEER_CONN_PARMS  \
            -c '{"function": "changeAssetOwner","args": ["ASSET0", "201393984", "Trần Văn Nam"]}'
